...
_PRESET_EGEMAPSV02_LLD_25MS_10MS = "egemapsv02_lld_25ms_10ms"


def preset_egemapsv02_lld_25ms_10ms(*, opensmile_home: str | Path) -> OpenSmilePreset:
    """Frame-level eGeMAPSv02 preset (25ms window, 10ms hop).

    Uses VAO wrapper config: `vao/opensmile_configs/egemapsv02_lld_25ms_10ms.conf`
    """
    ...
    config_path = Path(__file__).resolve().parent / "opensmile_configs" / "egemapsv02_lld_25ms_10ms.conf"
...
def get_preset(name: str, *, opensmile_home: str | Path) -> OpenSmilePreset:
    ...
    if key == _PRESET_EGEMAPSV02_LLD_25MS_10MS:
        return preset_egemapsv02_lld_25ms_10ms(opensmile_home=opensmile_home)
    ...
    raise ValueError(
        f"Unknown preset {name!r}. Supported presets: "
        f"{_PRESET_EGEMAPSV02_LLD_25MS_10MS!r}, {_PRESET_EGEMAPSV02_LLD_25MS_1MS!r}"
    )


def list_presets() -> Sequence[str]:
    return (_PRESET_EGEMAPSV02_LLD_25MS_10MS, _PRESET_EGEMAPSV02_LLD_25MS_1MS)
